...
<%
    ...
    if(cookies!=null)
    {
        for(Cookie cookie:cookies){
            {
                if("nurse_e_mail".equals(cookie.getName()))
                {
                    e_mail=cookie.getValue();
//                    System.out.println(e_mail);
                }
                if("nurse_password".equals(cookie.getName()))
...
<div class="loginForm" >
    <h2 class="h"><a href="homepage.jsp" link>护工系统</a> 护工登录</h2>
    <img  class="mx-auto d-block img-fluid"  src="images/user.png"  alt="center" height="300" width="300">
    <form action="loginnurseservlet" ,method="get">
...
<%--        </div>--%>
        <div>
            没有护士账户,<a href="registernurse.jsp">立即认证</a>
        </div>
    </form>
</div>
